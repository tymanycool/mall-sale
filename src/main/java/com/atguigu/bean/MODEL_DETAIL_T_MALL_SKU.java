...
public class MODEL_DETAIL_T_MALL_SKU extends T_MALL_SKU implements Serializable {
	...
	private List<OBJECT_T_MALL_SKU_AV_NAME> list_av_name;
	...
	public List<OBJECT_T_MALL_SKU_AV_NAME> getList_av_name() {
		return list_av_name;
	}

	public void setList_av_name(List<OBJECT_T_MALL_SKU_AV_NAME> list_av_name) {
